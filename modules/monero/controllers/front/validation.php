...
class moneroValidationModuleFrontController extends ModuleFrontController
{
	...
	public function postProcess()
	{
		...
		$status = "We are waiting for your payment to be confirmed by the ArQmA network.";

		$this->arqma_daemon = new Arqma_Library('http://'. $daemon_address .'/json_rpc');
	...
	{
		$arq_price = Tools::file_get_contents('https://min-api.cryptocompare.com/data/price?fsym=XMR&tsyms=BTC,USD,EUR,CAD,INR,GBP&extraParams=monero_woocommerce'); //api to change
